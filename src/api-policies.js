...
const getRoleColor = (role) => {
  switch(role) {
    ...
    case 'Wealth Manager': return 'purple';
    default: return 'blue';
  }
};
...
const APIPoliciesDemo = () => {
  ...
  const evaluateAccess = useCallback(() => {
    ...
    const permissionResults = selectedActions.map(action => {
      ...
      if (selectedResource === 'partners' && !['Wealth Manager', 'Administrator'].includes(selectedUser.role)) {
        allowed = false;
      }
      ...
      <div className="relative z-10 text-center py-8 px-4">
        <div className="inline-flex items-center bg-white rounded-2xl shadow-xl px-8 py-4">
          ...
          <div className="text-left">
            ...
            <p className="text-gray-600 text-sm">Wealth Management Platform Demo</p>
          </div>
        </div>
                ...
                <div className="space-y-3">
                  ...
                  {selectedResource === 'partners' && (
                    <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg flex items-center">
                      ...
                      <span className="text-amber-800">Partners require Wealth Manager or Administrator role</span>
                    </div>
                  )}
